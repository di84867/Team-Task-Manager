        ...
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4 transition-colors duration-300">
            ...
            <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-3xl shadow-xl dark:shadow-none border dark:border-slate-800 p-8 md:p-10 transition-colors">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-3xl font-black text-gray-900 dark:text-slate-100 tracking-tight">Welcome Back</h2>
                    <p className="text-gray-500 dark:text-slate-400 font-medium text-sm mt-1">Access your team dashboard</p>
                </div>

                <form onSubmit={handleLogin} className="space-y-5">
                    <div>
                        <label className="block text-xs font-black uppercase tracking-widest text-gray-400 dark:text-slate-500 mb-2 ml-1">Email Address</label>
                        <input 
                    ...
                    <div>
                        <label className="block text-xs font-black uppercase tracking-widest text-gray-400 dark:text-slate-500 mb-2 ml-1">Password</label>
                        <input 
                    ...
                    <button className="w-full bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-2xl font-bold text-lg shadow-lg shadow-blue-200 dark:shadow-none transition-all transform hover:scale-[1.01] active:scale-[0.98]">
                        Login
                    </button>
                </form>

                <p className="mt-8 text-center text-gray-500 dark:text-slate-400 font-medium">
                    New to Taskly? <Link to="/register" className="text-blue-600 hover:underline font-bold">Create Account</Link>
                </p>
            </div>
        </div>
    );
